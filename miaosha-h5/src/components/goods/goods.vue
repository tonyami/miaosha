<template>
  <div class="goods">
    ...
    <div class="desc">
      ...
      <p>
        1958年，闻名世界的棒棒糖（lollipop）的发明人恩里克·伯纳特·丰利亚多萨，首次推出这种带棍的糖果，结果使一家几乎经营不下去的糖果公司扭亏为盈。
      </p>
      <p>
    ...
    >
      <van-count-down
        :time="goods.duration * 1000"
        v-show="goods.status === 0"
        @finish="timerOver"
      />
    </van-submit-bar>
    <van-overlay :show="showOverLay" :z-index="9999" :lock-scroll="true">
      <van-loading size="36px" vertical color="#fff" class="wrapper"
        >排队中...</van-loading
      >
    </van-overlay>
  </div>
